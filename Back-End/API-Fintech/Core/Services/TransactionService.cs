...
namespace API_Fintech.Core.Services
{
    public class TransactionService
    {
        ...
        public async Task<IEnumerable<TransactionHistoryDto?>> GetLastTenTransactions(string email)
        {
                ...
                IEnumerable<Transaction?> transactions = await transactionRepository.GetProyectedMany(q => q.OriginAccountId == account.AccountNumber || q.DestinationAccountId == account.AccountNumber,
